# SkillDrop: Copilot Chat for client-call preparation

## Source learning content

- Product: AI Skills Navigator
- Course: Drive business value with Microsoft Copilot solutions
- Unit: Unit 3 of 8 - Explore Copilot experiences
- Concept: Copilot Chat for fast answers and organizational context
...
The learner should be able to explain how Copilot Chat can use organizational context to reduce manual search, improve preparation, and support faster decisions in the flow of work.

## Source scenario

Imagine a regional manager needs a summary of last quarter's performance before a client call. Copilot Chat pulls data from reports and emails, delivering a concise, accurate summary in seconds.

## Related ASN content to reference

When useful, reference the next related content in this same ASN module:

- Unit 4: Map business processes to Copilot solutions
- Unit 5: Extend and customize Copilot
- Unit 6: Explore responsible AI in Copilot

Do not invent additional ASN courses, catalog IDs, or learning paths. If suggesting next learning, keep it tied to this module unless ASN provides more content.
...
8. Suggest one optional Copilot follow-up automation idea based on the learner's scenario, such as a recurring weekly prep brief, meeting follow-up summary, customer-risk review, or stakeholder update draft. Frame it as a suggestion for later; do not claim automation has been created.
9. Show an end screen explaining what the learner learned, what they practiced, and the outcome they created.
10. Create a SkillDrop completion summary the learner can paste back into ASN.
11. Suggest a short Teams message they can send to a colleague to share this SkillDrop.
12. Provide a Teams share deep link that opens the message in Teams.
13. Tell the learner they can earn 250 Frontier Points by submitting the completion summary back to ASN, and 100 Frontier Points by sharing the SkillDrop with a colleague.
...
2. An end screen formatted as a final completion card with these sections, in this order:
   - What you learned
   - Continue in AI Skills Navigator
   - What you practiced
   - Your outcome
   - Suggested Copilot follow-up automation
   - Share with a colleague
   - SkillDrop completion summary
3. In "Your outcome," briefly explain why the output maps to the course concept.
4. In "SkillDrop completion summary," include these fields:
   - Skill practiced
   - Work scenario
...
8. A next step: "Submit your completion summary back to ASN to claim 250 Frontier Points. After submitting, you will return to Unit 3 with SkillDrop marked complete, then continue to Unit 4 for the demo conclusion and admin data view."

## Guardrails

- Do not invent ASN content, catalog IDs, adoption numbers, ROI, or business impact.
